...
////
////public:
////    virtual int NormalAttack() = 0; // void for now, pure abstract function (GameObject class) and can be override by other classes
////};
////
...
////        return 25;
////    }
////    virtual int SpecialAttack() = 0; // pure abstract function for Player class
////   
